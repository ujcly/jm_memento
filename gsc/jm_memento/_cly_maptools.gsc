/*
Contains simplified functions implemented in JH mod (_maptools.gsc and _ambient.gsc) to make the map playable locally.
*/
...
// Prevention against teleport abuse and other stuff (JH only)
setBusy(busy) {
